...
<section class="content">
     ...
     <div class="row">
          ...
          <div class="widget-user-image">
               <img class="img-circle" src="{{ asset('assets/dist/img/user3-128x128.jpg') }}" alt="User Avatar">
          </div>
          <div class="card-footer">
               <div class="row">
               <div class="col-sm-4 border-right">
     ...
     <div class="row">
          ...
          <div class="card-body">
               ...
               <img class="attachment-img" src="{{ asset('assets/dist/img/photo1.png') }}" alt="Attachment Image">
          ...
          <div class="card-footer card-comments">
               ...
               <div class="card-comment">
               <!-- User image -->
               <img class="img-circle img-sm" src="{{ asset('assets/dist/img/user5-128x128.jpg') }}" alt="User Image">
